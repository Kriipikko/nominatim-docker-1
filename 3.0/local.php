<?php
 ...
 // @define('CONST_Replication_Url', 'http://download.geofabrik.de/asia/gcc-states-updates/');
 @define('CONST_Replication_Url', 'http://NO_URL_FOR_NO_INTERNET_CONNECTION/asia/gcc-states-updates/');
